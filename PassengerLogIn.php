<?php
  ...
  if(isset($_POST['btnNew'])){
      header('Location: PassengerReg.php'); 
  }
...
body {
  ...
  background-image: url("image/passenger.jpg");
...
<body>
  ...
  <div class="wrapper">
    ...
    <form class="form-signin bg-secondary" method="post">
      	...
      	<h2 class="form-signin-heading text-center" ><b>Passenger</b><br> Login Form</h2>
      ...
      <br>
      <form method="post">
      <p class="text-center text-light"><b>Dont have Any Account?</b></p>
      <p class="text-center"> <button class="btn btn-sm btn-primary " name="btnNew">Create Account</button></p>
